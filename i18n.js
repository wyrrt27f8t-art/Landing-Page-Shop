...
const TEXTE = {
  de: {
    ...
    "chat.intro": "Frage zum Produkt, zur Lieferung oder sonst etwas? Schreib uns – wir antworten meist innerhalb eines Tages.",
    "chat.name": "Name (freiwillig)",
    "chat.email": "E-Mail-Adresse",
    "chat.message": "Deine Nachricht",
    "chat.send": "Nachricht senden",
    "chat.sending": "Wird gesendet...",
    "chat.success": "Danke! Deine Nachricht ist bei uns – wir melden uns per E-Mail.",
    "chat.error": "Da ist etwas schiefgelaufen. Schreib uns sonst direkt an info@mafo-pet.ch.",
    "chat.missing": "Bitte E-Mail-Adresse und Nachricht ausfüllen.",
    "chat.close": "Schliessen",
    "chat.note": "Wir brauchen deine E-Mail-Adresse nur, um dir zu antworten.",
  ...
  fr: {
    ...
    "chat.intro": "Une question sur le produit, la livraison ou autre chose ? Écris-nous – nous répondons généralement dans la journée.",
    "chat.name": "Nom (facultatif)",
    "chat.email": "Adresse e-mail",
    "chat.message": "Ton message",
    "chat.send": "Envoyer le message",
    "chat.sending": "Envoi en cours...",
    "chat.success": "Merci ! Ton message nous est bien parvenu – nous te répondrons par e-mail.",
    "chat.error": "Une erreur est survenue. Écris-nous directement à info@mafo-pet.ch.",
    "chat.missing": "Merci d'indiquer ton adresse e-mail et ton message.",
    "chat.close": "Fermer",
    "chat.note": "Nous utilisons ton adresse e-mail uniquement pour te répondre.",
  ...
  it: {
    ...
    "chat.title": "Scrivici",
    "chat.intro": "Hai una domanda sul prodotto, sulla consegna o su altro? Scrivici – di solito rispondiamo entro un giorno.",
    "chat.name": "Nome (facoltativo)",
    "chat.email": "Indirizzo e-mail",
    "chat.message": "Il tuo messaggio",
    "chat.send": "Invia messaggio",
    "chat.sending": "Invio in corso...",
    "chat.success": "Grazie! Abbiamo ricevuto il tuo messaggio – ti risponderemo via e-mail.",
    "chat.error": "Qualcosa è andato storto. Scrivici direttamente a info@mafo-pet.ch.",
    "chat.missing": "Inserisci indirizzo e-mail e messaggio.",
    "chat.close": "Chiudi",
    "chat.note": "Usiamo il tuo indirizzo e-mail solo per risponderti.",
  ...
  en: {
    ...
    "chat.intro": "A question about the product, delivery or anything else? Write to us – we usually reply within a day.",
    "chat.name": "Name (optional)",
    "chat.email": "Email address",
    "chat.message": "Your message",
    "chat.send": "Send message",
    "chat.sending": "Sending...",
    "chat.success": "Thank you! We have your message – we'll reply by email.",
    "chat.error": "Something went wrong. Please write to us directly at info@mafo-pet.ch.",
    "chat.missing": "Please fill in your email address and message.",
    "chat.close": "Close",
    "chat.note": "We use your email address only to reply to you.",
